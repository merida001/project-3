...
-- Note: You'll need to update the email and ensure this user exists in Supabase Auth
-- INSERT INTO users (id, email, name, role) 
-- VALUES ('00000000-0000-0000-0000-000000000000', 'admin@campus.edu', 'Admin', 'admin')
